...
const ALL_NAV_ITEMS: {
  ...
  { label: 'Status',         path: '/(officer)/status',            icon: 'shield-checkmark-outline', permission: PERMISSIONS.MANAGE_ATTENDANCE },
  ...
  { label: 'Announcements',  path: '/(officer)/announcements',     icon: 'megaphone-outline',        permission: PERMISSIONS.MANAGE_MEMBERS }, // any officer with member access can send
];
