...
const rh = StyleSheet.create({
  ...
  searchBox:   { flexDirection: 'row', alignItems: 'center', gap: 8, borderWidth: 1, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 6, minWidth: 160 },
  filterChip:  { borderWidth: 1, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 5 },
