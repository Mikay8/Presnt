...
const ms = StyleSheet.create({
  ...
  searchBox:   { flexDirection: 'row', alignItems: 'center', gap: 8, borderWidth: 1, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 8, minWidth: 180, flex: 1 },
  tabChip:     { borderWidth: 1, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 6 },
