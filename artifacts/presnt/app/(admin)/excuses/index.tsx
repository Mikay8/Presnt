...
function ExcuseItem({
  ...
  if (isWide) {
    return (
      <Pressable onPress={goToDetail} style={[ei.desktopRow, { borderBottomColor: c.border }]}>
        {/* Avatar */}
        ...
        {saving ? (
          ...
          <View style={{ flexDirection: 'row', gap: 8 }}>
            <Pressable onPress={(e) => { e.stopPropagation?.(); onDeny(); }} style={[ei.denyBtn, { borderColor: c.border }]}>
              <Text size="sm" weight="medium" color={c.text}>Deny</Text>
            </Pressable>
            <Pressable onPress={(e) => { e.stopPropagation?.(); onApprove(); }} style={[ei.approveBtn, { backgroundColor: c.primary }]}>
  ...
  // Mobile card
  return (
    <Pressable onPress={goToDetail} style={[ei.mobileCard, { backgroundColor: c.surface, borderColor: c.border }]}>
      ...
      {isPending && (
        saving ? (
          ...
          <View style={{ flexDirection: 'row', gap: 8 }}>
            <Pressable onPress={(e) => { e.stopPropagation?.(); onDeny(); }} style={[ei.denyBtn, { flex: 1, borderColor: c.border }]}>
              <Text size="sm" weight="medium" color={c.text}>Deny</Text>
            </Pressable>
            <Pressable onPress={(e) => { e.stopPropagation?.(); onApprove(); }} style={[ei.approveBtn, { flex: 1, backgroundColor: c.primary }]}>
              <Text size="sm" weight="medium" style={{ color: '#fff' }}>Approve</Text>
            </Pressable>
          </View>
        )
